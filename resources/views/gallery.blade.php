...
<body>
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
      <div class="container px-5 py-20 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Gallery</h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Gallery Laptop Service Cirebon</p>
        </div>
      </div>
    </section>
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
      <div class="container px-5 mx-auto">
        ...
        @foreach ($servs as $gallerylist)
          <div class="lg:w-1/4 md:w-1/2 p-4 w-full transform transition duration-500 hover:scale-110">
            <a class="block relative h-48 rounded overflow-hidden">
              <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ asset('storage/' . $gallerylist->filegambar) }}">
            </a>
            <div class="mt-4">
              <h2 class="text-white title-font text-lg font-medium">{{ mb_strimwidth($gallerylist->namabarang, 0, 100, '...') }}</h2>
              <p class="mt-1">{{ mb_strimwidth($gallerylist->keterangan, 0, 100, '...') }}</p>
            </div>
          </div>
        @endforeach
