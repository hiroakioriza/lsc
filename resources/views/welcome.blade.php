    ...
    <div class="px-1 py-6 mx-auto lg:py-3 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-3">
      <div class="relative flex items-center justify-between lg:justify-center lg:space-x-16">
        <ul class="flex items-center hidden space-x-8 lg:flex">
          <li><a href="/" aria-label="Home" title="Home" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Home</a></li>
          <li><a href="Customer" aria-label="Customer" title="Customer" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Customer</a></li>
        </ul>
        ...
        <div class="lg:hidden z-20">
          <button aria-label="Open Menu" title="Open Menu" class="p-2 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline mobile-menu-button">
          ...
          <div class="absolute top-0 left-0 w-full lg:hidden hidden mobile-menu">
            <div class="p-5 bg-white border rounded shadow-sm">
              <div class="flex items-center justify-between mb-4">
                ...
                <div>
                  <button aria-label="Close Menu" title="Close Menu" class="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline close-menu">
                    <svg class="w-5 text-gray-600" viewBox="0 0 24 24">
              ...
              <nav>
                <ul class="space-y-4">
                  ...
                  <li><a href="Customer" aria-label="Customer" title="Customer" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Customer</a></li>
